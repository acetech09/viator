/**
 * Feather-style eye / eye-off glyph for "visibility" affordances (a group counted in the
 * list vs. hidden from it). Stroke uses currentColor so the parent button controls color.
 */
